...
public class ResTest {
  ...
  /**
   * 
   * Test for the Fail_ID304256 method.
   * 
   */
  @Test
  public void testFail_ID3042562() {
...
""");
      ...
      Assert.assertEquals("[695462]", result.getHttpCode(), 200);
  ...
  /**
   * 
   * Test for the Success_ID657951 method.
   * 
   */
  @Test
  public void testSuccess_ID6579512() {
    MiniClient c = new MiniClient();
    c.setConnectorEndpoint(connector.getHttpEndpoint());
...
""");
      ...
      Assert.assertNotEquals("[131546]", result.getHttpCode(), 200);
